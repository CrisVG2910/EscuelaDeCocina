...
/*
*   Agregar los Post Types de Instructores y Clases
*/
...
/*
*   Funciones cargadas al activar el theme
*/
function edc_setup() {
...
/*
* Agregar clase nav-link de bootstrap
*/
...
// Agregar mensaje personalizado en el admin
...
function remove_comment_form_cookie_checkbox($fields) {
    unset($fields['cookies']);
    return $fields;
}
add_filter('comment_form_default_fields', 'remove_comment_form_cookie_checkbox');