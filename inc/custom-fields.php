...
function edc_seccion_nosotros() {
	...
	$edc_iconos->add_group_field( $group_field_id, array(
		...
		'description' => esc_html__( 'Agregue una descripción a esta caracterisitica', 'cmb2' ),
		'id'          => 'desc_icono',
		'type'        => 'textarea_small',
	) );
...
function edc_campos_blog() {
	...
	$edc_campos_blog->add_field( array(
		...
		'desc' => esc_html__( 'Añada una descripción para la sección', 'cmb2' ),
		'id'   => $prefix . 'slogan_blog',
		'type' => 'text',
	) );
}

// Añadir campos al Post Types de clases
...
function edc_campos_clases() {
	...
	$edc_campos_cursos = new_cmb2_box( array(
		'id'           => $prefix . 'metabox',
		'title'        => esc_html__( 'Información de Clase y Cursos', 'cmb2' ),
	...
	$edc_campos_cursos->add_field( array(
		'name'     => esc_html__( 'Info Fecha y Horarios del Curso', 'cmb2' ),
		'desc'     => esc_html__( 'Añadir fechas, días y horas para el curso', 'cmb2' ),
		'id'       => $prefix . 'info',
		'type'     => 'title',
	) );
	...
	$edc_campos_cursos->add_field( array(
		...
		'desc' => esc_html__( 'Añadir fecha de inicio de curso', 'cmb2' ),
	...
	$edc_campos_cursos->add_field( array(
		...
		'desc' => esc_html__( 'Añadir fecha de fin de curso', 'cmb2' ),
	...
	$edc_campos_cursos->add_field( array(
		'name'     => esc_html__( 'Infromación Extra del Curso', 'cmb2' ),
	...
	$edc_campos_cursos->add_field( array(
		'name' => esc_html__( 'Cupos', 'cmb2' ),
		'desc' => esc_html__( 'Cupos para el curso', 'cmb2' ),
		'id'   => $prefix . 'cupo',
		'type' => 'text',
	) );
	...
	$edc_campos_cursos->add_field( array(
		...
		'desc' => esc_html__( 'Seleccione el chef que impartirá del curso', 'cmb2' ),
		'id'   => $prefix . 'chef',
		'limit' => 10,
